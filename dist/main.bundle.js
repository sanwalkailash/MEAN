...
var attendance_component_1 = __webpack_require__("./src/app/attendance/attendance.component.ts");
var holidays_component_1 = __webpack_require__("./src/app/holidays/holidays.component.ts");
var resources_component_1 = __webpack_require__("./src/app/resources/resources.component.ts");
...
var routes = [
    ...
    { path: environment_1.environment.ROUTE_ATTENDANCE, component: attendance_component_1.AttendanceComponent, canActivate: [auth_guard_1.AuthGuard] },
    { path: environment_1.environment.ROUTE_HOLIDAYS, component: holidays_component_1.HolidaysComponent, canActivate: [auth_guard_1.AuthGuard] },
    { path: environment_1.environment.ROUTE_RESOURCES, component: resources_component_1.ResourcesComponent, canActivate: [auth_guard_1.AuthGuard] },
        ...
        this.showError = function (error) {
            switch (error.code) {
                case error.PERMISSION_DENIED:
                    _this.Notification = "Error : Share Location";
                    break;
                case error.POSITION_UNAVAILABLE:
                    _this.Notification = "Error : Location unavailable.";
                    break;
                case error.TIMEOUT:
                    _this.Notification = "The request to get user location timed out.";
                    break;
                case error.UNKNOWN_ERROR:
                    _this.Notification = "Error : An unknown error occurred.";
                    break;
            }
        };
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                holidays_component_1.HolidaysComponent,
...
var AuthService = /** @class */ (function () {
    function AuthService(subject, util) {
        var _this = this;
    ...
    AuthService.prototype.logout = function () {
        ...
        this.util.getRouter().navigate([environment_1.environment.ROUTE_LOGIN]);
    };
    AuthService = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [broadcast_service_1.BroadcastService, util_service_1.UtilService])
    ], AuthService);
    return AuthService;
}());
...
module.exports = "<footer class=\"footer\" >\n    <p>&copy; 2019 resourceManager All rights reserved | Powered By Pahadi.Me.</p>\n    <div>\n<!--        <button>-->\n<!--            <i class=\"material-icons \">add_box</i>-->\n<!--        </button>-->\n<!--        <button>-->\n<!--            <i class=\"material-icons \">add_comment</i>-->\n<!--        </button>-->\n    </div>\n</footer>\n"
...
var HolidaysComponent = /** @class */ (function () {
    ...
    HolidaysComponent = __decorate([
        core_1.Component({
            ...
            template: __webpack_require__("./src/app/holidays/holidays.component.html"),
            styles: [__webpack_require__("./src/app/holidays/holidays.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], HolidaysComponent);
    return HolidaysComponent;
}());
exports.HolidaysComponent = HolidaysComponent;
...
var UtilService = /** @class */ (function () {
    ...
    UtilService.prototype.uploadFile = function (fileToUpload) {
...
var SigninComponent = /** @class */ (function () {
    ...
    SigninComponent.prototype.fileEvent = function (event) {
        ...
        reader.onload = function (evt) {
            ...
            _this.loginJSON.register.resume.result = evt.target["result"];
        };
